...
from qt_ui.diagnostics_window import DiagnosticsWindow
from qt_ui.widgets.recording_panel import RecordingPanel
from qt_ui.recording_manager import RecordingManager
from qt_ui.widgets.mission_planner import MissionPlanner
from qt_ui.widgets.config_editor import ConfigEditor
...
def main():
    ...
    rec_panel.setWindowTitle("HuntEye â€” Recording")
    rec_panel.resize(500, 400)
    rec_panel.show()

    mission.setWindowTitle("HuntEye â€” Mission Planner")
    mission.resize(500, 600)
    mission.show()

    config.setWindowTitle("HuntEye â€” Config Editor")
