...
from ui.widgets.fps_graph import FPSGraph
from ui.widgets.worker_panel import WorkerPanel
from ui.widgets.metrics_panel import MetricsPanel
from ui.widgets.cam_view import CameraView
...
class HuntEyeDashboard(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("HuntEye — Operator Dashboard")
